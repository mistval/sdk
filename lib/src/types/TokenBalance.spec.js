...
function createHold(instance, expires, quantity, name) {
...
describe("fungible", () => {
    it("should add quantity", () => {
        ...
        // When
        balance.ensureCanAddQuantity(new bignumber_js_1.default(1)).add();
        // Then
    ...
    it("should fail to add quantity if balance contains NFT instances", () => {
        // Given
        const balance = emptyBalance();
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        // When
        const error = () => balance.ensureCanAddQuantity(new bignumber_js_1.default(1));
        // Then
    ...
    it("should subtract quantity", () => {
        ...
        // When
        balance.ensureCanAddQuantity(new bignumber_js_1.default(1)).add();
        balance.ensureCanSubtractQuantity(new bignumber_js_1.default(1), Date.now()).subtract();
        // Then
    ...
    it("should fail to subtract quantity if balance is insufficient", () => {
        ...
        const balance = emptyBalance();
        // When
        const error = () => balance.ensureCanSubtractQuantity(new bignumber_js_1.default(1), Date.now());
        // Then
    ...
    it("should fail to subtract quantity if quantity is locked by TokenHold", () => {
        ...
        balance.ensureCanAddQuantity(new bignumber_js_1.default(10)).add();
    ...
    it("should fail to unlock a TokenHold Quantity with mismatched name", () => {
        ...
        // When
        const error = () => balance.ensureCanUnlockQuantity(lockedTotal, Date.now(), nameForUnlockAttempt).unlock();
        // Then
...
describe("non-fungible", () => {
    it("should add nft instance", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        balance.ensureCanAddInstance(new bignumber_js_1.default(2)).add();
        // Then
    ...
    it("should fail to add nft instance if instance already exists", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        const error = () => balance.ensureCanAddInstance(new bignumber_js_1.default(1));
        // Then
    ...
    it("should fail to add nft instance if instance id is invalid", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        const errorZero = () => balance.ensureCanAddInstance(new bignumber_js_1.default(0));
        const errorNegative = () => balance.ensureCanAddInstance(new bignumber_js_1.default(0));
        const errorDecimal = () => balance.ensureCanAddInstance(new bignumber_js_1.default(0));
        // Then
    ...
    it("should remove nft instance", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        balance.ensureCanRemoveInstance(new bignumber_js_1.default(1), Date.now()).remove();
        // Then
    ...
    it("should fail to remove nft instance not in balance", () => {
        ...
        const balance = emptyBalance();
        // When
        const error = () => balance.ensureCanRemoveInstance(new bignumber_js_1.default(1), Date.now());
        // Then
    ...
    it("should fail to lock instance for non-nft instanceId", () => {
        ...
        const balance = emptyBalance();
        // When
        balance.ensureCanAddQuantity(new bignumber_js_1.default(0)).add();
    ...
    it("should unlock locked instance", () => {
        ...
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        balance.ensureCanLockInstance(unexpiredHold, Date.now()).lock();
        balance.ensureCanUnlockInstance(new bignumber_js_1.default(1), undefined, Date.now()).unlock();
        // Then
        expect(balance).toEqual(expect.objectContaining({
            lockedHolds: []
        }));
    ...
    it("should fail to unlock already unlocked instance", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        const error = () => balance.ensureCanUnlockInstance(new bignumber_js_1.default(1), undefined, Date.now());
        // Then
    ...
    it("should release in use instance", () => {
        ...
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        balance.ensureCanUseInstance(unexpiredHold, Date.now()).use();
        balance.ensureCanReleaseInstance(new bignumber_js_1.default(1), undefined, Date.now()).release();
        // Then
        expect(balance).toEqual(expect.objectContaining({
            inUseHolds: []
        }));
    ...
    it("should fail to release instance not in use", () => {
        ...
        // When
        balance.ensureCanAddInstance(new bignumber_js_1.default(1)).add();
        const error = () => balance.ensureCanReleaseInstance(new bignumber_js_1.default(1), undefined, Date.now());
        // Then
    ...
    it("should clear holds", () => {
        ...
        const balance = emptyBalance();
        balance.ensureCanAddInstance(new bignumber_js_1.default(6)).add();
        balance.ensureCanAddInstance(new bignumber_js_1.default(7)).add();
